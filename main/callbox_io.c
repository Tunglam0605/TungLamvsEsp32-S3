...
/*
 * ⚠️ QUAN TRỌNG: các số kênh đầu ra dưới đây phản ánh ĐÚNG đấu nối vật lý
 * trên board Waveshare / đầu ra expander TCA9554 như firmware gốc đã dùng
 * (BUZZER_PIN=1, TOWER_RED=2, TOWER_YELLOW=3, TOWER_GREEN=4,
 * LED_BTN_1=5, LED_BTN_2=6, LED_BTN_3=7). DO ánh xạ tới bit 0..7 của TCA.
 *
 *   DI1  GPIO4  nút cancel        DO1 P0  buzzer
 *   DI2  GPIO5  nút task 2        DO2 P1  tower đỏ
 *   DI3  GPIO6  nút task 1        DO3 P2  tower vàng
 ...
 *                                  DO8 P7  LED trạng thái AP
 *
 * Nếu bo mạch vật lý được đấu lại, CHỈ đổi một file này.
 */
